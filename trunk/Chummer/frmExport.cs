...
namespace Chummer
{
	public partial class frmExport : Form
	{
		...
		private void frmExport_Load(object sender, EventArgs e)
		{
			...
			foreach (string strFile in Directory.GetFiles(Application.StartupPath + "\\export"))
			{
				...
				{
					string strFileName = strFile.Replace(Application.StartupPath + "\\export\\", string.Empty).Replace(".xsl", string.Empty);
		...
		private void cmdOK_Click(object sender, EventArgs e)
		{
			...
			StreamReader objFile = new StreamReader(Application.StartupPath + "\\export\\" + cboXSLT.Text + ".xsl");
			...
			objXSLTransform.Load(Application.StartupPath + "\\export\\" + cboXSLT.Text + ".xsl"); // Use the path for the export sheet.
